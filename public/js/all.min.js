...
else{this.playerDie(enemy);}},enemyDie:function(enemy){var tweenEnemy=this.game.add.tween(enemy);tweenEnemy.to({alpha:0},400,Phaser.Easing.Linear.None,true);this.time.events.add(300,function(){enemy.kill();tweenEnemy.stop();this.addEnemy();},this);this.player.body.velocity.y=-100;this.enemyKillSound.play();this.game.global.score+=2;this.updateScoreText();},playerDie:function(enemy){if(!this.player.alive){return;}
if(typeof enemy!=='undefined'){this.enemyStop(enemy);}
this.player.kill();this.playerLives-=1;this.deadSound.play();this.jumpSound.stop();this.startExplosion();this.time.events.add(1000,function(){if(this.playerLives<1){this.game.state.start('menu');}
