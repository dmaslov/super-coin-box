...
var scoreLabel=this.game.add.text(this.game.world.centerX,this.game.world.centerY,'score: '+this.game.global.score+'\nbest score: '+this.bestScoreValue,{font:'25px Arcade',fill:'#fff',align:'center'});scoreLabel.anchor.setTo(0.5,0.5);var startLabel=this.game.add.text(this.game.world.centerX,this.game.world.height-110,startText,{font:'25px Arcade',fill:'#fff'});startLabel.anchor.setTo(0.5,0.5);startLabel.alpha=0;this.game.add.tween(startLabel).to({alpha:1},1000,Phaser.Easing.Linear.None,true,0,1000,true);},initBestScore:function(){var storagePrefix='phaserGame::';var bestScore=storagePrefix+'bestScore';this.bestScoreValue=localStorage.getItem(bestScore);if(!this.bestScoreValue){localStorage.setItem(bestScore,0);this.bestScoreValue=0;}
